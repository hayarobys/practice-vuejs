    ...
    export default {
        ...
        methods: {
            onClickTd(){
                ...
                //this.$store.commit('CLICK_CELL',{row:this.rowIndex, cell:this.cellIndex}); // 문자열은 오타낼 가능성이 있음
                this.$store.commit(CLICK_CELL,{row:this.rowIndex, cell:this.cellIndex}); // 변수명은 브라우저에서 에러를 찾아주기에 권장
